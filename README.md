...
**Multi-language online coding platform with real-time compilation**
...
### 🟣 Data Science Lead — Google Developer Student Club
- 🎓 Trained **150+ students** in Python, R, SQL & Machine Learning
- 📚 Organized workshops and hackathons
- 🌟 Built community around data science learning

### 🟣 NSS Social Work Lead
- 🤝 Organized multiple impactful community service events
- 👥 Mobilized 100+ students for social initiatives
- 💚 Community impact and social responsibility

### 🟣 Infineon Hackathon Winner
- 🏅 Automated Excel preprocessing using Python
- ⚙️ Improved data accuracy by 40% and processing speed by 3x
...
|--------|-----------|-------------|
| **B.Tech CSE** | Lovely Professional University, Punjab | **CGPA: 7.63** |
| **Intermediate (12th)** | Maa K.D.R.R Inter College | **80.8%** |
